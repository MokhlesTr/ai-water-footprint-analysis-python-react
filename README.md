...
![AI Water Footprint Dashboard Banner](./comprehensive_ai_water_analysis.png)
...
_Running this script will output terminal predictions, generate two PNG graphs, and successfully export a `data.json` file straight into the React frontend folder._
...
_Open your browser and navigate to `http://localhost:5173` to view the interactive dashboard._
...
_Created for academic and research presentation purposes._
